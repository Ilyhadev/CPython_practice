...
static long __pyx_f_9factorial_fact(int, int __pyx_skip_dispatch); /*proto*/
...
/* #### Code section: decls ### */
static PyObject *__pyx_pf_9factorial_fact(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n); /* proto */
...
#define __pyx_kp_u_factorial_pyx __pyx_string_tab[1]
...
#define __pyx_n_u_fact __pyx_string_tab[5]
...
#define __pyx_kp_b_iso88591_q_q_U_3b_1 __pyx_string_tab[20]
...
static PyObject *__pyx_pw_9factorial_1fact(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static long __pyx_f_9factorial_fact(int __pyx_v_n, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  long __pyx_v_result;
  long __pyx_r;
  long __pyx_t_1;
...
static PyMethodDef __pyx_mdef_9factorial_1fact = {"fact", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9factorial_1fact, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9factorial_1fact(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "fact", 0) < (0)) __PYX_ERR(0, 2, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("fact", 1, 1, 1, i); __PYX_ERR(0, 2, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("fact", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 2, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("factorial.fact", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9factorial_fact(__pyx_self, __pyx_v_n);
...
static PyObject *__pyx_pf_9factorial_fact(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n) {
  ...
  __pyx_t_1 = __pyx_f_9factorial_fact(__pyx_v_n, 1); if (unlikely(__pyx_t_1 == ((long)-1L) && PyErr_Occurred())) __PYX_ERR(0, 2, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyLong_From_long(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 2, __pyx_L1_error)
 ...
 *     cdef long result = 1
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_9factorial_1fact, 0, __pyx_mstate_global->__pyx_n_u_fact, NULL, __pyx_mstate_global->__pyx_n_u_factorial, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_fact, __pyx_t_2) < (0)) __PYX_ERR(0, 2, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{13},{20},{18},{18},{4},{9},{8},{13},{5},{8},{10},{1},{8},{3},{12},{12},{10},{8},{6},{36}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (185 bytes) */
const char* const cstring = "x\332=\216\261j\303@\020D\301\310 H\021p\343Z?`\010\376\2004\251\2150\270\036\326\347\025\034>\335I\272=#u.U^\351OS\351O\361\206\004o\361\230a\231a\276\0332\022\006Kn\327M#P+\352\351\307\032\301\201G9rCq\362\306\206\235\tCHb=G\343\224\260\0362\220\3413\231\353o\311\273\010h\2227\000l\304;d\205\333\010\264\2441\2756\\\222c@\215\247VE\027:\240O\344\376,\020Y\376_\252.:#9\001\204\243\362F.q\274\177\316\375\263\330\346~)\312y=\237r\225\367\371\374X=\252\245\334\344j)>\346\257\027/\350Xh";
    ...
    #endif
    #else /* compression: none (223 bytes) */
const char* const bytes = "?factorial.pyx__Pyx_PyDict_NextRefasyncio.coroutinescline_in_tracebackfactfactorial__func___is_coroutineitems__main____module__n__name__pop__qualname____set_name__setdefault__test__values\200\017\210q\340\004\027\220q\330\004\010\210\005\210U\220!\2203\220b\230\002\230!\330\010\022\220!\330\004\013\2101";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_factorial_pyx, __pyx_mstate->__pyx_n_u_fact, __pyx_mstate->__pyx_kp_b_iso88591_q_q_U_3b_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
